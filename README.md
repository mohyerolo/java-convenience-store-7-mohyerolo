...
| 상황    | 예시                                                         | 처리 방법    |
|-------|------------------------------------------------------------|----------|
| 없는 파일 | "notFound.txt"                                             | 없는 파일 에러 |
| 필드 에러 | name,price,quantity,promotion 양식인데 name,price,quantity만 있음 | 양식 에러    |

- 프로모션 리스트로 변환

| 상황    | 예시                                            | 처리 방법 |
|-------|-----------------------------------------------|-------|
| 필드 에러 | 6가지 필드가 존재하지 않음 or 각 필드별 타입에 맞지 않는 문자가 들어가 있음 | 양식 에러 |

- 편의점 상품으로 변환

| 상황    | 예시                                            | 처리 방법 |
|-------|-----------------------------------------------|-------|
| 필드 에러 | 5가지 필드가 존재하지 않음 or 각 필드별 타입에 맞지 않는 문자가 들어가 있음 | 양식 에러 |
