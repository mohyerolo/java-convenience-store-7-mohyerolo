...
//    public static final String RECEIPT_ORDER_PROMOTION_FIELD = "%-6s\t\t\t%-2d\n";
//    public static final String RECEIPT_DIVIDER = "====================================\n";
//    public static final String TOTAL_AMOUNT = "총구매액  \t\t\t%-2d\t\t  %6s\n";
//    public static final String PROMOTION_DISCOUNT = "행사할인  \t\t\t\t\t  %6s\n";
//    public static final String MEMBERSHIP_DISCOUNT = "멤버십할인 \t\t\t\t\t\t\t\t%-6s\n";
//    public static final String REAL_AMOUNT_TO_PAY = "내실돈   \t\t\t\t\t  %6s\n";

    public static final String RECEIPT_STORE_NAME = "\n==============W 편의점================\n";
    public static final String RECEIPT_ORDER_FIELD_NAME = "상품명\t\t\t\t수량\t금액\n";
    public static final String RECEIPT_ORDER_ITEM_FIELD = "%s\t\t\t\t%-2d\t\t%-6s\n";

    public static final String RECEIPT_PROMOTION_PART = "=============증\t\t정===============\n";
    public static final String RECEIPT_ORDER_PROMOTION_FIELD = "%s\t\t\t\t%-2d\n";
    public static final String RECEIPT_DIVIDER = "====================================\n";
    public static final String TOTAL_AMOUNT = "총구매액\t\t\t\t%-2d\t\t%6s\n";
    public static final String PROMOTION_DISCOUNT = "행사할인\t\t\t\t\t\t%6s\n";
    public static final String MEMBERSHIP_DISCOUNT = "멤버십할인\t\t\t\t\t\t\t\t%-6s\n";
